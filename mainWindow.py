...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setFixedSize(1018, 746)
        # self.setFixedSize(1527, 746)
        ...
        self.input_windows = {self.blood_glucose: Glucose(self), self.food_intake: Foodlist(self),
                              self.sleep_hours: Sleep(self), self.walk_steps: Exercise(self)}
        ...
        self.graph_window.setGeometry(2, 385, 1010, 325)
